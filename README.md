...
### 1팀
> **`담당 운영진`** : 김예은, 이시현, 이동령
> **`아기사자`** : 이선재, 김나현, 김예원, 오지환, 한수현, 한은선

### 2팀
> **`담당 운영진`** : 이한주, 김홍진, 주시현, 박진아
> **`아기사자`** : 이연택, 최홍석, 이가희, 최효리, 전주원, 홍진욱

### 3팀
> **`담당 운영진`** : 이민성, 최재오, 이성
> **`아기사자`** : 장유선, 이서아, 이상혁, 김승환

### 4팀
> **`담당 운영진`** : 이혜윤, 정민경, 박세현
> **`아기사자`** : 조맑음, 홍성준, 최주용, 박동하, 부준혁
...
<br/>
  ...
  |**7/14 금**
  15:00|행사장 입장 완료
  15:10|오리엔테이션|일정 및 주의사항 안내
  15:40 ~ 20:30|자율 개발|저녁 식사 시간 포함 (각 팀 자율)
  18:00|사원증 및 간식 배부
  20:30 ~ 22:00|사자들의 여름밤|현직 개발자 선배님들과 함께하는 커피챗
  22:00 ~ |자율 개발
  **7/30 토**
  03:00|깜짝 이벤트
   ~ 06:30|자율 개발
  **06:30**|**발표 자료 및 데모 결과물 제출 마감**|이 시간 이후로 본인의 서비스를 **더이상 개발할 수 없습니다.**
  06:30 ~ 07:00|데모 서비스 체험|다른 팀의 서비스를 직접 사용해보는 시간을 가집니다.
  07:00 ~ 09:00|발표 및 질의응답
  09:00 ~ 09:30|평가 및 해커톤 종료
